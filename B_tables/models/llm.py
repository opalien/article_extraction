...
column_name_to_question = {
    "model": "Quel est le modèle de l'article ?",
    "architecture": "Quel est l'architecture de l'article ?",
    "parameters": "Combien de paramètres a l'article ?",
    "id_country": "Quel est le pays de l'article ?",
    "id_hardware": "Quel est le hardware de l'article ?",
    "h_compute": "Combien de compute a l'article ?",
    "h_power": "Combien de power a l'article ?",
    "h_number": "Combien de nombre a l'article ?",
    "training_time_id_hardware": "Combien de temps a l'article ?",
    "training_compute": "Combien de compute a l'article ?",
    "power_draw": "Combien de power a l'article ?",
    "co2eq": "Combien de co2eq a l'article ?",
    "year": "Quel est l'année de l'article ?",
}

def extract_fn(file_content: str, column_name: str) -> str:
    question = column_name_to_question[column_name]
    return llm(file_content, question)[0]
